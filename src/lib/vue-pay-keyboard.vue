<template>
    <transition name="fade">
        <div class="pay-box" v-if="isPay">
            ...
            <div class="pay-shadow" v-if="isPay"></div>
            ...
            <div v-if="isPay">
                ...
                <div class="pas-box v-1px" v-show="keyShow">
                    <div v-for="(pas, i) in pasDigits" :key="i" :class="{ 'v-1px-l' : i > 0 }">
                        <input type="password" :value="password[i]" disabled>
                    </div>
                </div>
                ...
                <div class="key-box" v-if="keyShow">
                    <div class="item v-1px-t" v-for="(item, i) in keyList" :key="i">
                        <div class="key" v-for="(val, key) in item" :key="key"
                            :class="{'v-1px-l' : key != 0}"
                ...
                <!-- 密码输入完毕动画 -->
                <div class="loading" v-show="loadingShow" ref="loading">
